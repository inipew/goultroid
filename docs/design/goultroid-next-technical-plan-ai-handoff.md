> **LATEST REFINEMENT CONTINUATION (2026-09-26):** P1-A canonical presentation vocabulary is complete at `27b1f0fe7dd2e2d25d568daca2632a7d52a82bc9`. Continue from **P1-B** using **docs/design/goultroid-refinement-p1b-final-ai-session-handoff.md**. That handoff covers the single Telegram keyboard serializer, native/userbot a2 adapter, Settings/MyXL legacy callback migration, legacy callback removal, plugin-hook API cleanup, localization/error/UI cleanup, benchmark-driven resource refinement, and final closure acceptance. Refresh current source first; source/tests outrank this pointer.
