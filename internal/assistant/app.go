...
type AssistantApp struct { client *client.AssistantClient; logger *zap.Logger }
...
func NewBotClient(appID int, appHash string, botToken string, logger *zap.Logger) *AssistantApp { return NewApp(appID, appHash, botToken, logger) }
...
func (a *AssistantApp) SetOwner(ownerID int64, sudoGetter func() []int64) { a.client.SetOwner(ownerID, sudoGetter) }
